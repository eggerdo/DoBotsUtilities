...
public class RoboCommands {
	...
	public class DriveCommand extends BaseCommand {
		...
		public DriveCommand(String i_strRobot, Move i_eMove, double i_dblSpeed, double i_dblAngle) {
		...
		public DriveCommand(JSONObject i_oObj) throws JSONException {
			...
			eMove 		= Move.valueOf(data.getString(RoboCommandTypes.F_MOVE));
	...
	public static DriveCommand createDriveCommand(String i_strRobot, Move i_eMove, double i_dblSpeed, double i_dblAngle) {
		return getInstance().new DriveCommand(i_strRobot, i_eMove, i_dblSpeed, i_dblAngle);
	}
	
	public static DriveCommand createDriveCommand(String i_strRobot, Move i_eMove, double i_dblSpeed) {
